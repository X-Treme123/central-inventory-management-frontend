// app/dashboard/stock-in/add-item/[id]/page.tsx - Updated dengan barcode scanning workflow
"use client";
...
export default function AddStockInItemPage() {
  ...
  const handleSubmitItem = async (e: React.FormEvent) => {
    ...
    try {
      const response = await addStockInItemByBarcode(token, id as string, formData);
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <Alert variant="destructive">
          ...
          <AlertDescription>
            {error || "Cannot add items to this stock in. It may be completed or not found."}
          </AlertDescription>
        </Alert>
        <Button
          className="mt-4"
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        <h4 className="font-medium text-green-800">Scan Information</h4>
                        ...
                        <div>
                          ...
                          >
                            <SelectTrigger className="mt-1">
                              <SelectValue 
                                placeholder={
                                  formData.warehouse_id ? "Select container" : "Select warehouse first"
                                } 
                              />
                            </SelectTrigger>
                            <SelectContent>
                        ...
                        <div>
                          ...
                          >
                            <SelectTrigger className="mt-1">
                              <SelectValue 
                                placeholder={
                                  formData.container_id ? "Select rack" : "Select container first"
                                } 
                              />
                            </SelectTrigger>
                            <SelectContent>
                    ...
                    <div className="bg-gray-700 p-4 rounded-lg">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        <div>
                          ...
                          <p className="font-semibold">{formData.quantity} {scanResult.scan_info.detected_unit_type}(s)</p>
                        </div>
                        <div>
                          <p className="text-blue-600">Total Pieces</p>
                          <p className="font-semibold">{calculateTotalPieces().toLocaleString('id-ID')}</p>
                        </div>
                        <div>
                          <p className="text-blue-600">Price per Unit</p>
                          <p className="font-semibold">{formData.price_per_unit.toLocaleString('id-ID')} IDR</p>
                        </div>
                        <div>
                          <p className="text-blue-600">Total Amount</p>
                          <p className="font-semibold text-lg">{calculateTotalAmount().toLocaleString('id-ID')} IDR</p>
                        </div>
                      </div>
                    </div>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="text-sm space-y-3">
                <div className="flex items-start gap-2">
                  <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded font-medium">1</span>
                  <p>Point your iWare scanner at the product barcode</p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded font-medium">2</span>
                  <p>Press the trigger to scan - barcode will appear automatically</p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded font-medium">3</span>
                  <p>System will detect product and unit type</p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded font-medium">4</span>
                  <p>Enter quantity and select storage location</p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded font-medium">5</span>
            ...
            <Card>
              ...
              <CardContent className="text-sm space-y-2">
                <p><strong>Scanner not working?</strong> Check USB connection and ensure cursor is in the barcode field.</p>
                <p><strong>Product not found?</strong> Register the product in Products section first.</p>
                <p><strong>Wrong unit detected?</strong> Check if you're scanning the correct barcode for the unit type.</p>
              </CardContent>
            </Card>
          </div>
        </div>
