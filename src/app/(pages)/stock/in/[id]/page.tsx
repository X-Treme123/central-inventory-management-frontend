// app/stock/in/[id]/page.tsx - Updated dengan barcode information display
"use client";
            ...
            <div className="flex items-center gap-3">
              ...
              {stockIn.status === "pending" && (
                <div className="flex gap-2">
                  <Button
                    onClick={() => router.push(`/stock/in/add-item/${stockInId}`)}
                    variant="outline"
                  >
              ...
              <div className="text-center py-12">
                ...
                {stockIn.status === "pending" && (
                  <div className="space-y-3">
                    <Button onClick={() => router.push(`/stock/in/add-item/${stockInId}`)}>
                      <Scan className="h-4 w-4 mr-2" />
