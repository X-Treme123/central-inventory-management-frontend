// features/pages/categories/components/EditCategoryPage.tsx
"use client";
...
export default function EditCategoryPage({ categoryId }: EditCategoryPageProps) {
  ...
  const { 
    ...
    fetchFn: (token) => getCategoryById(token, categoryId).then(res => res.data),
    deps: [categoryId],
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updateCategory(token, categoryId, { name, description });
